...
import com.actionbazaar.persistence.ActivationLink;
...
public abstract class User implements Serializable {
    ...
    /**
     * Activation links - outstanding activations
     */
    @OneToMany(cascade = CascadeType.ALL,fetch= FetchType.LAZY)
    private Set<ActivationLink> activationLinks = new HashSet<ActivationLink>();
    ...
    /**
     * Adds a new ActivationLink
     * @param activationLink - activationLink
     */
    public void addActivationLink(ActivationLink activationLink) {
